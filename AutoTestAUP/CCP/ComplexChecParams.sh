...
ls $ACTIVE_DIR/rdt | column -t > $ACTIVE_DIR/tmp/files_list.tmp
...
export VER_PROTOCOL=$VER_PROTOCOL
...
echo -e "Версия прошивки: ${GREEN}$VERS${NC}"
...
echo "------------------------------------------------------------------------" >> $LOG
echo "" >> $LOG
echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Тестируем файл: $NAME_FILE]" >> $LOG
echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Название прибора: $namerus]" >> $LOG
echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][id прибора: $id]" >> $LOG
echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Версия прошивки: $VERS]" >> $LOG
echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Версия протокола: $VER_PROTOCOL]" >> $LOG
echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][База данных: $Name]" >> $LOG
echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Имя пользователя: $Login]" >> $LOG
echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Пароль: $Password]" >> $LOG
echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Хост: $Host]" >> $LOG
echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Порт: $Port]" >> $LOG
echo "" >> $LOG
...
if [ "$STR1" != "$STR2" ]; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][TYPE: FILE -> $TYPE DB -> $DB_TYPE параметры не совпали]" >> $LOG
else
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][TYPE: FILE -> $TYPE DB -> $DB_TYPE параметры совпали]" >> $LOG
fi
# SN
...
if echo "$SN" | grep -wq "$DB_SN"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][SN: FILE -> $SN DB -> $DB_SN параметры совпали]" >> $LOG
else
    echo -e "${RED}FILE ==>    $STR1${NC}"
    echo -e "${RED}DB   ==>    $STR2${NC}"
    echo "---------------------------"
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][SN: FILE -> $SN DB -> $DB_SN параметры не совпали]" >> $LOG
fi
# VERS
VERS=$(cat $TARGET | grep vers -i | grep -oE '[0-9]*\.?[0-9]+')
# Комплекс или смарт?
...
if echo "$VERS" | grep -wq "$DB_VERS"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][VERS: FILE -> $VERS DB -> $DB_VERS параметры совпали]" >> $LOG
else
    echo -e "${RED}FILE ==>    $STR1${NC}"
    echo -e "${RED}DB   ==>    $STR2${NC}"
    echo "---------------------------"
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][VERS: FILE -> $VERS DB -> $DB_VERS параметры не совпали]" >> $LOG
fi
#SIMIP
...
if echo "$SIMIP" | grep -wq "$DB_SIMIP"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][SIMIP: FILE -> $SIMIP_LOG DB -> $DB_SIMIP параметры совпали]" >> $LOG
else
    echo -e "${RED}FILE ==>    $STR1${NC}"
    echo -e "${RED}DB   ==>    $STR2${NC}"
    echo "---------------------------"
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][SIMIP: FILE -> $SIMIP_LOG DB -> $DB_SIMIP параметры не совпали]" >> $LOG
fi
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №1 STATUS_SYSTEM: FILE -> $STATUS_SYSTEM DB -> $DB_STATUS_SYSTEM параметры совпали]" >> $LOG
    ((i++))
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №1 STATUS_SYSTEM: FILE -> $STATUS_SYSTEM DB -> $DB_STATUS_SYSTEM параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №2 VOLUME_PULSE: FILE -> $VOLUME_PULSE DB -> $DB_VOLUME_PULSE параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №2 VOLUME_PULSE: FILE -> $VOLUME_PULSE DB -> $DB_VOLUME_PULSE параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №3 CURRENT_COUNTER: FILE -> $CURRENT_COUNTER DB -> $DB_CURRENT_COUNTER параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №3 CURRENT_COUNTER: FILE -> $CURRENT_COUNTER DB -> $DB_CURRENT_COUNTER параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №4 DATETIME: FILE -> $DATETIME DB -> $DB_DATETIME параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №4 DATETIME: FILE -> $DATETIME DB -> $DB_DATETIME параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №5 APN_ADDRESS: FILE -> $APN_ADDRESS DB -> $DB_APN_ADDRESS параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №5 APN_ADDRESS: FILE -> $APN_ADDRESS DB -> $DB_APN_ADDRESS параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №6 APN_LOGIN: FILE -> $APN_LOGIN DB -> $DB_APN_LOGIN параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №6 APN_LOGIN: FILE -> $APN_LOGIN DB -> $DB_APN_LOGIN параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №7 APN_PASSWORD: FILE -> $APN_PASSWORD DB -> $DB_APN_PASSWORD параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №7 APN_PASSWORD: FILE -> $APN_PASSWORD DB -> $DB_APN_PASSWORD параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №8 TCP_ADDRESS: FILE -> $TCP_ADDRESS DB -> $DB_TCP_ADDRESS параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №8 TCP_ADDRESS: FILE -> $TCP_ADDRESS DB -> $DB_TCP_ADDRESS параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №9 SMS_PHONE: FILE -> $SMS_PHONE DB -> $DB_SMS_PHONE параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №9 SMS_PHONE: FILE -> $SMS_PHONE DB -> $DB_SMS_PHONE параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
...
if [ -n "$select" ]; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №10 BALANCE_PHONE: FILE -> $BALANCE_PHONE DB -> $DB_BALANCE_PHONE параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №10 BALANCE_PHONE: FILE -> $BALANCE_PHONE DB -> $DB_BALANCE_PHONE параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №11 MODE_TRANSFER: FILE -> $MODE_TRANSFER DB -> $DB_MODE_TRANSFER параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №11 MODE_TRANSFER: FILE -> $MODE_TRANSFER DB -> $DB_MODE_TRANSFER параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №12 BATTERY: FILE -> $BATTERY DB -> $DB_BATTERY параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №12 BATTERY: FILE -> $BATTERY DB -> $DB_BATTERY параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №13 SENSOR_TEMP: FILE -> $SENSOR_TEMP DB -> $DB_SENSOR_TEMP параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №13 SENSOR_TEMP: FILE -> $SENSOR_TEMP DB -> $DB_SENSOR_TEMP параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №14 RESERVE_INTERVAL: FILE -> $RESERVE_INTERVAL DB -> $DB_RESERVE_INTERVAL параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №14 RESERVE_INTERVAL: FILE -> $RESERVE_INTERVAL DB -> $DB_RESERVE_INTERVAL параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №15 SEANCECNT_MAX: FILE -> $SEANCECNT_MAX DB -> $DB_SEANCECNT_MAX параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №15 SEANCECNT_MAX: FILE -> $SEANCECNT_MAX DB -> $DB_SEANCECNT_MAX параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №16 SEANCECNT: FILE -> $SEANCECNT DB -> $DB_SEANCECNT параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №16 SEANCECNT: FILE -> $SEANCECNT DB -> $DB_SEANCECNT параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №17 SEANCECNT_ERR: FILE -> $SEANCECNT_ERR DB -> $DB_SEANCECNT_ERR параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №17 SEANCECNT_ERR: FILE -> $SEANCECNT_ERR DB -> $DB_SEANCECNT_ERR параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №18 GAS_DAY: FILE -> $GAS_DAY DB -> $DB_GAS_DAY параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №18 GAS_DAY: FILE -> $GAS_DAY DB -> $DB_GAS_DAY параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №19 HWVERSION: FILE -> $HWVERSION DB -> $DB_HWVERSION параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №19 HWVERSION: FILE -> $HWVERSION DB -> $DB_HWVERSION параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №20 AUTOSWITH: FILE -> $AUTOSWITH DB -> $DB_AUTOSWITH параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №20 AUTOSWITH: FILE -> $AUTOSWITH DB -> $DB_AUTOSWITH параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        $ACTIVE_DIR/ModARC3.sh
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №21 LASTCHANGEARCNUM: FILE -> $LASTCHANGEARCNUM DB -> $DB_LASTCHANGEARCNUM параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №21 LASTCHANGEARCNUM: FILE -> $LASTCHANGEARCNUM DB -> $DB_LASTCHANGEARCNUM параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
...
if (( $(echo "$VERS_S < 1.273700" | bc -l) )); then
    ...
    unset PGPASSWORD
    LASTSYSARCNUM=$(echo "${arr[$i]}" | grep -oE '[0-9]+')
    STR1="LASTEVENTARCNUM: $LASTSYSARCNUM"
    ...
    sleep 0.2
        if echo "$STR1" | grep -wq "$STR2"; then
            ...
            DATE_STR=$(date +"%d.%m.%Y")
            TIME_STR=$(date +"%H:%M:%S")
            echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №22 LASTSYSARCNUM: FILE -> $LASTSYSARCNUM DB -> $DB_LASTSYSARCNUM параметры совпали]" >> $LOG
            ((i++))
            if [ "$i" -ge "$COUNTERS" ]; then
                # Запускаем подменю программы
                $ACTIVE_DIR/ModARC3.sh
            ...
            DATE_STR=$(date +"%d.%m.%Y")
            TIME_STR=$(date +"%H:%M:%S")
            echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №22 LASTSYSARCNUM: FILE -> $LASTSYSARCNUM DB -> $DB_LASTSYSARCNUM параметры не совпали]" >> $LOG
            ((i++))
            if [ "$i" -ge "$COUNTERS" ]; then
                # Запускаем подменю программы
                $ACTIVE_DIR/ModARC3.sh
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №23 LASTHOURARCNUM: FILE -> $LASTHOURARCNUM DB -> $DB_LASTHOURARCNUM параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №23 LASTHOURARCNUM: FILE -> $LASTHOURARCNUM DB -> $DB_LASTHOURARCNUM параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №24 LASTDAYARCNUM: FILE -> $LASTDAYARCNUM DB -> $DB_LASTDAYARCNUM параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №24 LASTDAYARCNUM: FILE -> $LASTDAYARCNUM DB -> $DB_LASTDAYARCNUM параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №25 P_ABS: FILE -> $P_ABS DB -> $DB_P_ABS параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        exit 0
    fi
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №25 P_ABS: FILE -> $P_ABS DB -> $DB_P_ABS параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        exit 0
    fi
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №26 LASTVALVECMD: FILE -> $LASTVALVECMD DB -> $DB_LASTVALVECMD параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №26 LASTVALVECMD: FILE -> $LASTVALVECMD DB -> $DB_LASTVALVECMD параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №27 VALVESTATE: FILE -> $VALVESTATE DB -> $DB_VALVESTATE параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №27 VALVESTATE: FILE -> $VALVESTATE DB -> $DB_VALVESTATE параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №28 CNT_FAIL_SIM: FILE -> $CNT_FAIL_SIM DB -> $DB_CNT_FAIL_SIM параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №28 CNT_FAIL_SIM: FILE -> $CNT_FAIL_SIM DB -> $DB_CNT_FAIL_SIM параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №29 CNT_FAIL_SPEED: FILE -> $CNT_FAIL_SPEED DB -> $DB_CNT_FAIL_SPEED параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        $ACTIVE_DIR/ModARC3.sh
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №29 CNT_FAIL_SPEED: FILE -> $CNT_FAIL_SPEED DB -> $DB_CNT_FAIL_SPEED параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        $ACTIVE_DIR/ModARC3.sh
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №30 VALVE_AUTO_CTL: FILE -> $VALVE_AUTO_CTL DB -> $DB_VALVE_AUTO_CTL параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        $ACTIVE_DIR/MenuAC.sh
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №30 VALVE_AUTO_CTL: FILE -> $VALVE_AUTO_CTL DB -> $DB_VALVE_AUTO_CTL параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        $ACTIVE_DIR/MenuAC.sh
...
LIMIT 1;")
unset PGPASSWORD
DB_KFAKTOR=$(echo "$arcdata" | jq -r '.K')
KFAKTOR=${arr[$i]}
STR1="KFAKTOR: ${arr[$i]}"
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №31 KFAKTOR: FILE -> $KFAKTOR DB -> $DB_KFAKTOR параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        $ACTIVE_DIR/ModARC3.sh
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №31 KFAKTOR: FILE -> $KFAKTOR DB -> $DB_KFAKTOR параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        $ACTIVE_DIR/ModARC3.sh
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №32 LASTTELARCNUM: FILE -> $LASTTELARCNUM DB -> $DB_LASTTELARCNUM параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №32 LASTTELARCNUM: FILE -> $LASTTELARCNUM DB -> $DB_LASTTELARCNUM параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
...
unset PGPASSWORD
BATTERY_PERCENT=$(echo "${arr[$i]}" | grep -oE '[0-9]*\.?[0-9]+')
STR1="BATTERY_PERCENT: $BATTERY_PERCENT"
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №33 BATTERY_PERCENT: FILE -> $BATTERY_PERCENT DB -> $DB_BATTERY_PERCENT параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        $ACTIVE_DIR/MenuAC.sh
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №33 BATTERY_PERCENT: FILE -> $BATTERY_PERCENT DB -> $DB_BATTERY_PERCENT параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        $ACTIVE_DIR/MenuAC.sh
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №34 TCP_ADDRESS2: FILE -> $TCP_ADDRESS2 DB -> $DB_TCP_ADDRESS2 параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №34 TCP_ADDRESS2: FILE -> $TCP_ADDRESS2 DB -> $DB_TCP_ADDRESS2 параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
...
if [ -n "$VERS_K" ]; then
    if (( $(echo "$VERS_K >= 1.050299" | bc -l) )); then
        ...
        if echo "$STR1" | grep -wq "$STR2"; then
            ...
            DATE_STR=$(date +"%d.%m.%Y")
            TIME_STR=$(date +"%H:%M:%S")
            echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №35 AUTO_OFF_REZREP: FILE -> $AUTO_OFF_REZREP DB -> $DB_AUTO_OFF_REZREP параметры совпали]" >> $LOG
            ((i++))
            if [ "$i" -ge "$COUNTERS" ]; then
                # Запускаем подменю программы
                exit 0
            ...
            DATE_STR=$(date +"%d.%m.%Y")
            TIME_STR=$(date +"%H:%M:%S")
            echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №35 AUTO_OFF_REZREP: FILE -> $AUTO_OFF_REZREP DB -> $DB_AUTO_OFF_REZREP параметры не совпали]" >> $LOG
            ((i++))
            if [ "$i" -ge "$COUNTERS" ]; then
                # Запускаем подменю программы
                exit 0
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №36 SERIAL_BOARD: FILE -> $SERIAL_BOARD DB -> $DB_SERIAL_BOARD параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №36 SERIAL_BOARD: FILE -> $SERIAL_BOARD DB -> $DB_SERIAL_BOARD параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №37 SGS_PHONE2: FILE -> $SGS_PHONE2 DB -> $DB_SGS_PHONE2 параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №37 SGS_PHONE2: FILE -> $SGS_PHONE2 DB -> $DB_SGS_PHONE2 параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №38 WARNINGSTATE: FILE -> $WARNINGSTATE DB -> $DB_WARNINGSTATE параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №38 WARNINGSTATE: FILE -> $WARNINGSTATE DB -> $DB_WARNINGSTATE параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №39 ALARMSTATE: FILE -> $ALARMSTATE DB -> $DB_ALARMSTATE параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №39 ALARMSTATE: FILE -> $ALARMSTATE DB -> $DB_ALARMSTATE параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №40 CRASHSTATE: FILE -> $CRASHSTATE DB -> $DB_CRASHSTATE параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №40 CRASHSTATE: FILE -> $CRASHSTATE DB -> $DB_CRASHSTATE параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №41 STATUS_STORY: FILE -> $STATUS_STORY DB -> $DB_STATUS_STORY параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №41 STATUS_STORY: FILE -> $STATUS_STORY DB -> $DB_STATUS_STORY параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №42 ERROR_SESSION_SERVER2: FILE -> $ERROR_SESSION_SERVER2 DB -> $DB_ERROR_SESSION_SERVER2 параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №42 ERROR_SESSION_SERVER2: FILE -> $ERROR_SESSION_SERVER2 DB -> $DB_ERROR_SESSION_SERVER2 параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
...
if [ -n "$VERS_K" ]; then
    if (( $(echo "$VERS_K >= 1.050299" | bc -l) )); then
        ...
        if echo "$STR1" | grep -wq "$STR2"; then
            ...
            DATE_STR=$(date +"%d.%m.%Y")
            TIME_STR=$(date +"%H:%M:%S")
            echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №43 CNT_REZREP: FILE -> $CNT_REZREP DB -> $DB_CNT_REZREP параметры совпали]" >> $LOG
            ((i++))
            if [ "$i" -ge "$COUNTERS" ]; then
                # Запускаем подменю программы
                exit 0
            ...
            DATE_STR=$(date +"%d.%m.%Y")
            TIME_STR=$(date +"%H:%M:%S")
            echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №43 CNT_REZREP: FILE -> $CNT_REZREP DB -> $DB_CNT_REZREP параметры не совпали]" >> $LOG
            ((i++))
            if [ "$i" -ge "$COUNTERS" ]; then
                # Запускаем подменю программы
                exit 0
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №44 BATTERY_TELEMETRY: FILE -> $BATTERY_TELEMETRY DB -> $DB_BATTERY_TELEMETRY параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        $ACTIVE_DIR/MenuAC.sh
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №44 BATTERY_TELEMETRY: FILE -> $BATTERY_TELEMETRY DB -> $DB_BATTERY_TELEMETRY параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        $ACTIVE_DIR/MenuAC.sh
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №45 CURRENT_FLOW: FILE -> $CURRENT_FLOW DB -> $DB_CURRENT_FLOW параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №45 CURRENT_FLOW: FILE -> $CURRENT_FLOW DB -> $DB_CURRENT_FLOW параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №46 CURRENT_FLOW_DISPL: FILE -> $CURRENT_FLOW_DISPL DB -> $DB_CURRENT_FLOW_DISPL параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №46 CURRENT_FLOW_DISPL: FILE -> $CURRENT_FLOW_DISPL DB -> $DB_CURRENT_FLOW_DISPL параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №47 LASTVSDIST: FILE -> $LASTVSDIST DB -> $DB_LASTVSDIST параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №47 LASTVSDIST: FILE -> $LASTVSDIST DB -> $DB_LASTVSDIST параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №48 CURRENT_COUNTER_GLOB: FILE -> $CURRENT_COUNTER_GLOB DB -> $DB_CURRENT_COUNTER_GLOB параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        $ACTIVE_DIR/ModARC3.sh
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №48 CURRENT_COUNTER_GLOB: FILE -> $CURRENT_COUNTER_GLOB DB -> $DB_CURRENT_COUNTER_GLOB параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        $ACTIVE_DIR/ModARC3.sh
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №49 STATUS_RS485: FILE -> $STATUS_RS485 DB -> $DB_STATUS_RS485 параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        $ACTIVE_DIR/ModARC3.sh
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №49 STATUS_RS485: FILE -> $STATUS_RS485 DB -> $DB_STATUS_RS485 параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        $ACTIVE_DIR/ModARC3.sh
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №50 SIM_ENABLE: FILE -> $SIM_ENABLE DB -> $DB_SIM_ENABLE параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №50 SIM_ENABLE: FILE -> $SIM_ENABLE DB -> $DB_SIM_ENABLE параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №51 SIM_ACTIV: FILE -> $SIM_ACTIV DB -> $DB_SIM_ACTIV параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №51 SIM_ACTIV: FILE -> $SIM_ACTIV DB -> $DB_SIM_ACTIV параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №52 MODEM_IMEI: FILE -> $MODEM_IMEI DB -> $DB_MODEM_IMEI параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №52 MODEM_IMEI: FILE -> $MODEM_IMEI DB -> $DB_MODEM_IMEI параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №53 EN_ARCHIVE_SIM3: FILE -> $EN_ARCHIVE_SIM3 DB -> $DB_EN_ARCHIVE_SIM3 параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №53 EN_ARCHIVE_SIM3: FILE -> $EN_ARCHIVE_SIM3 DB -> $DB_EN_ARCHIVE_SIM3 параметры  не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №54 TEMP_BOARD: FILE -> $TEMP_BOARD DB -> $DB_TEMP_BOARD параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        $ACTIVE_DIR/MenuAC.sh
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №54 TEMP_BOARD: FILE -> $TEMP_BOARD DB -> $DB_TEMP_BOARD параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        $ACTIVE_DIR/MenuAC.sh
...
unset PGPASSWORD
EXT_ANT=$(echo "${arr[$i]}" | grep -oE '[0-9]+')
STR1="EXT_ANT: $EXT_ANT"
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №55 EXT_ANT: FILE -> $EXT_ANT DB -> $DB_EXT_ANT параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        $ACTIVE_DIR/ModARC3.sh
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №55 EXT_ANT: FILE -> $EXT_ANT DB -> $DB_EXT_ANT параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        $ACTIVE_DIR/ModARC3.sh
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №56 GAS_MON: FILE -> $GAS_MON DB -> $DB_GAS_MON параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №56 GAS_MON: FILE -> $GAS_MON DB -> $DB_GAS_MON параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        exit 0
...
if echo "$STR1" | grep -wq "$STR2"; then
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Passed][Параметр №57 LASTMONARCNUM: FILE -> $LASTMONARCNUM DB -> $DB_LASTMONARCNUM параметры совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        $ACTIVE_DIR/ModARC3.sh
    ...
    DATE_STR=$(date +"%d.%m.%Y")
    TIME_STR=$(date +"%H:%M:%S")
    echo "[$DATE_STR][$TIME_STR][$MOD][$MODULE_NAME][Failed][Параметр №57 LASTMONARCNUM: FILE -> $LASTMONARCNUM DB -> $DB_LASTMONARCNUM параметры не совпали]" >> $LOG
    ((i++))
    if [ "$i" -ge "$COUNTERS" ]; then
        # Запускаем подменю программы
        $ACTIVE_DIR/ModARC3.sh
