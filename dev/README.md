...
#### AUP Performance
Описание:
Программа проводит проверку необходимых условий для правильной работы AUP после его установки.
...
```
* после внесения изменений необходимо перезапустить "postgresql.service"
```sh
